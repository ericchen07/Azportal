...
namespace ImportCaseDetails
{
    class ImportCaseDetails : SPJobDefinition
    {
        public ImportCaseDetails() : base() { }
        public ImportCaseDetails(string jobName, SPService service)
            : base(jobName, service, null, SPJobLockType.None)
        {
            this.Title = "Import Azure Case Details";
        }
        public ImportCaseDetails(string jobName, SPWebApplication webapp)
