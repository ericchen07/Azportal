...
namespace LSIActiveRCAUpdate
{
    class LSIActiveRCAUpdate : SPJobDefinition
    {
        public LSIActiveRCAUpdate() : base() { }
        public LSIActiveRCAUpdate(string jobName, SPService service)
            : base(jobName, service, null, SPJobLockType.None)
        {
            this.Title = "LSI Active RCA Update Job";
        }
        public LSIActiveRCAUpdate(string jobName, SPWebApplication webapp)
        ...
        {
            LSIActiveRCAUpdateLogic();
        }

        public void LSIActiveRCAUpdateLogic()
        {
