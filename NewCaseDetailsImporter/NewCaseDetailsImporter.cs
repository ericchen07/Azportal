...
namespace NewCaseDetailsImporter
{
    class NewCaseDetailsImporter : SPJobDefinition
    {
        public NewCaseDetailsImporter() : base() { }
        public NewCaseDetailsImporter(string jobName, SPService service)
            : base(jobName, service, null, SPJobLockType.None)
        {
            this.Title = "Import Azure Case Details Job";
        }
        public NewCaseDetailsImporter(string jobName, SPWebApplication webapp)
