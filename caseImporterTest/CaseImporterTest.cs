...
namespace CaseImporterTest
{
    class CaseImporterTest : SPJobDefinition
    {
        public CaseImporterTest() : base() { }
        public CaseImporterTest(string jobName, SPService service)
            : base(jobName, service, null, SPJobLockType.None)
        {
            this.Title = "Import Azure Case Test";
        }
        public CaseImporterTest(string jobName, SPWebApplication webapp)
        ...
        public void UpdateCaseInfoTest()
        {
