...
namespace UpdateCaseStatus
{
    class UpdateCaseStatus : SPJobDefinition
    {
        public UpdateCaseStatus() : base() { }
        public UpdateCaseStatus(string jobName, SPService service)
            : base(jobName, service, null, SPJobLockType.None)
        {
            this.Title = "Update Case Status Job";
        }
        public UpdateCaseStatus(string jobName, SPWebApplication webapp)
        ...
        {
            UpdateCaseStatusDetails();
        }

        public void UpdateCaseStatusDetails()
        {
